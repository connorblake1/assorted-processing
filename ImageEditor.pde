// version 1.4 Connor's Version -- see update info starting @ line 83.
// September 19, 2016
// author: Harlan Howe
...
class ImageEditor
{
  ...
  */
  ...
  {
    return (getRedForColor(colorAt(x,y))+getGreenForColor(colorAt(x,y))+getBlueForColor(colorAt(x,y)))/3;}
  
  int grayAt(int x, int y) { return getGrayAt(x,y);}
  /**
  ...
  */
  ...
  {
    surface.setSize(myWidth*max(1,mx), myHeight*max(1,my) + 40);
